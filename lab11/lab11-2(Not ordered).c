...
void add_student(gradeNode* myGrades)
{
    ...
    strcpy(myGrades->studentList[myGrades->studentNum].name, temp_name);
    printf("Adding grade:");
    scanf("%d", &myGrades->studentList[myGrades->studentNum].grades);
    myGrades->avg += myGrades->studentList[myGrades->studentNum].grades;
    arrange_student(myGrades, myGrades->studentList[myGrades->studentNum].grades);
    myGrades->studentNum ++;
    //**************************
}
...
void update_student(gradeNode* myGrades)
{
    ...
    printf("Update:");
    scanf("%d", &myGrades->studentList[i].grades);
    myGrades->avg += myGrades->studentList[i].grades;
    //**************************
}
